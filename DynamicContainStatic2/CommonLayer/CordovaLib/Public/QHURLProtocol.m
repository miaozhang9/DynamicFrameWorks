...
NSString* const kQHAssetsLibraryPrefixes = @"assets-library://";

@implementation QHURLProtocol
...
+ (BOOL)canInitWithRequest:(NSURLRequest*)theRequest
{
    ...
    if ([[theUrl absoluteString] hasPrefix:kQHAssetsLibraryPrefixes]) {
        return YES;
    }
...
- (void)startLoading
{
    ...
    if ([[url absoluteString] hasPrefix:kQHAssetsLibraryPrefixes]) {
