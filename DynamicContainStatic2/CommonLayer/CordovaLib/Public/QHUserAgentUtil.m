...
static NSString* const kQHUserAgentKey = @"ToCred_iOS";//Cordova-User-Agent
static NSString* const kQHUserAgentVersionKey = @"Cordova-User-Agent-Version";
...
@implementation QHUserAgentUtil
...
+ (NSString*)originalUserAgent
{
    if (gOriginalUserAgent == nil) {
        ...
        NSString* cordovaUserAgentVersion = [userDefaults stringForKey:kQHUserAgentVersionKey];
        gOriginalUserAgent = [userDefaults stringForKey:kQHUserAgentKey];
        ...
        if ((gOriginalUserAgent == nil) || cachedValueIsOld) {
            ...
            [userDefaults setObject:gOriginalUserAgent forKey:kQHUserAgentKey];
            [userDefaults setObject:systemAndLocale forKey:kQHUserAgentVersionKey];
