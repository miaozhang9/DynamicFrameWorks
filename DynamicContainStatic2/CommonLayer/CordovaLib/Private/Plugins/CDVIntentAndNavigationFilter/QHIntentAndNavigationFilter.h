...
typedef NS_ENUM(NSInteger, QHIntentAndNavigationFilterValue) {
    QHIntentAndNavigationFilterValueIntentAllowed,
    QHIntentAndNavigationFilterValueNavigationAllowed,
    QHIntentAndNavigationFilterValueNoneAllowed
};

@interface QHIntentAndNavigationFilter : QHPlugin <NSXMLParserDelegate>
