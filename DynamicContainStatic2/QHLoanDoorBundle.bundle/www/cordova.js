...
function convertMessageToArgsNativeToJs(message) {
    var args = [];
    if (!message || !message.hasOwnProperty('QHType')) {
        args.push(message);
    } else if (message.QHType == 'MultiPart') {
...
exports.mapModules = function(context) {
    var origSymbols = {};
    context.QH_origSymbols = origSymbols;
...
exports.getOriginalSymbol = function(context, symbolPath) {
    var origSymbols = context.QH_origSymbols;
