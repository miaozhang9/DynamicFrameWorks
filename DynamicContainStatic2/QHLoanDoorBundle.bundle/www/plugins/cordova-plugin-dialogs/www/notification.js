...
module.exports = {
    ...
    alert: function(message, completeCallback, title, buttonLabel) {
        ...
        exec(completeCallback, null, "QHDialogsPlugin", "alert", [_message, _title, _buttonLabel]);
    },
    ...
    confirm: function(message, resultCallback, title, buttonLabels) {
        ...
        exec(resultCallback, null, "QHDialogsPlugin", "confirm", [_message, _title, _buttonLabels]);
    },
    ...
    prompt: function(message, resultCallback, title, buttonLabels, defaultText) {
        ...
        exec(resultCallback, null, "QHDialogsPlugin", "prompt", [_message, _title, _buttonLabels, _defaultText]);
    },
    ...
    beep: function(count) {
        ...
        exec(null, null, "QHDialogsPlugin", "beep", [ defaultedCount ]);
    }
};
